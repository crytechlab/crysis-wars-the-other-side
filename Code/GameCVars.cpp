...
void SCVars::InitCVars(IConsole *pConsole)
{
  ...
  pConsole->Register("g_fraglead", &g_fraglead, 1, 0, "Number of frags a player has to be ahead of other players once g_fraglimit is reached. Default is 1.");
	...
	pConsole->Register("g_spawn_force_timeout", &g_spawn_force_timeout, 20, 0, "player will be force-respawned after this timeout (in seconds)");
...
//	pConsole->Register("g_trooperPhysicsAnimBlendSpeed", &g_trooperPhysicAnimBlendSpeed, 100.f, VF_DUMPTODISK, "Trooper tentacle dynamic physics/anim blending speed");
	...
	pConsole->Register("hud_showTeamIcons", &hud_showTeamIcons, 1, 0, "Show player names over their heads, team always, enemy when hitting.");
	pConsole->Register("hud_showRadarObjectiveIcons", &hud_showRadarObjectiveIcons, 1, 0, "Show objective icons on the radar.");
	pConsole->Register("hud_showGrenadeIcons", &hud_showGrenadeIcons, 1, 0, "Show grenade indicator icons.");
	pConsole->Register("hud_showFunMessages", &hud_showFunMessages, 0, 0, "Show score messages for player.");
...
void SCVars::ReleaseCVars()
{
	...
	pConsole->UnregisterVariable("g_spawn_force_timeout", true);
  ...
  pConsole->UnregisterVariable("v_debugSounds", true);
	...
	pConsole->UnregisterVariable("hud_showTeamIcons", true);
	pConsole->UnregisterVariable("hud_showRadarObjectiveIcons", true);
	pConsole->UnregisterVariable("hud_showGrenadeIcons", true);
	pConsole->UnregisterVariable("hud_showFunMessages", true);
