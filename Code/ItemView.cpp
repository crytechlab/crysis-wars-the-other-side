...
-------------------------------------------------------------------------
History:
- 30:8:2005   12:52 : Created by Mбrcio Martins
...
//------------------------------------------------------------------------
void CItem::UpdateTPCharacter()
{
	ICharacterInstance *pCharacter = GetEntity()->GetCharacter(eIGS_FirstPerson);
	if (!m_idleAnimation[eIGS_ThirdPerson].empty())
		PlayAction(m_idleAnimation[eIGS_ThirdPerson], 0, true);
}
