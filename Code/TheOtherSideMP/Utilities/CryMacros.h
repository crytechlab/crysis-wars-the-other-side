...
#define CRY_SHOW_ONLY_REASON
//#define CRY_COMPILE_MESSAGES_AS_WARNINGS


#if defined(USER_marcio)
#undef CRY_SHOW_COMPILE_MESSAGES
#endif
...
# elif defined(CRY_SHOW_ONLY_REASON)
#	define CRY_PP_FORMAT_MESSAGE(day, month, year, reason, message)		CRY_PP_FORMAT_FILE_LINE " "#reason": " CRY_PP_FORMAT_DATE(day, month, year) ": " message
# else
