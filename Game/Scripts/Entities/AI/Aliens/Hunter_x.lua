...
function InitScriptEvents(table)
	table.scripted_events =
	{
		...
		faceopen =
		{
			...
			func = function(self)
				self:PlaySoundEvent("sounds/Alien:hunter:face_open", { x = 0, y = 6, z = 8 }, g_Vectors.v010,
		...
		faceclose =
		{
			event = ALIENEVENT_CALLFUNCTION,
			func = function(self)
				self:PlaySoundEvent("sounds/Alien:hunter:face_close", { x = 0, y = 6, z = 8 }, g_Vectors.v010,
					SOUND_DEFAULT_3D, SOUND_SEMANTIC_LIVING_ENTITY);
			end,
		},
		glow_charge =
...
function Hunter_x.Client:ClKill()
...
--Crysis co-op
function Hunter_x:OnResetClient()
	--sounds
	self:StopSounds();
...
function Hunter_x:OnResetCustom()
	...
	self:SetAttachmentEffect(0, "weak_point_effect_01", "alien_special.Hunter.weakPoint", g_Vectors.v000, g_Vectors.v010,
		0.5, 0);
	self:SetAttachmentEffect(0, "weak_point_effect_02", "alien_special.Hunter.weakPoint", g_Vectors.v000, g_Vectors.v010,
		1, 0);
	self:SetAttachmentEffect(0, "weak_point_effect_03", "alien_special.Hunter.weakPoint", g_Vectors.v000, g_Vectors.v010,
		1, 0);
