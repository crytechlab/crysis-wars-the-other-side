...
PowerStruggle.SoundAlert=
{
	Radio=
	{
		tan=
		{
			...
			tac									= "mp_korean/nk_commander_singularity_01",
...
----------------------------------------------------------------------------------------------------
function PowerStruggle:IsCapturing(buildingId)
	if (self.capturing[buildingId]) then
...
----------------------------------------------------------------------------------------------------
function PowerStruggle:IsContested(buildingId)
	if (self.contested[buildingId]) then
		return true;
	end
