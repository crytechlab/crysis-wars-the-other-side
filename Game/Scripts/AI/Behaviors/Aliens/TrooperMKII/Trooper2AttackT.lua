...
--
--------------------------------------------------------------------------
AIBehaviour.Trooper2AttackT = {
	Name = "Trooper2AttackT",
	Base = "TROOPERDEFAULT",
	alertness = 2,
	...
	--		entity:EnableTargetSearchBeam(true);
		end
	end,
...
--			AI.Signal(SIGNALFILTER_SENDER,0,"CHOOSE_TO_SEEK",entity.id);
--			System.Log("  GO_TO_INTRESTED");
--		elseif (state == GS_SEARCH or state == GS_ALERTED or state == GS_IDLE) then
--			AI.Signal(SIGNALFILTER_SENDER,0,"CHOOSE_TO_SEARCH",entity.id);
--			System.Log("  GO_TO_SEARCH");
--		else
--			AI.NotifyGroupTacticState(entity.id, 0, GN_NOTIFY_ADVANCING);
--			AI.Signal(SIGNALFILTER_SENDER,0,"CHOOSE_TO_ATTACK",entity.id);
--			System.Log("  GO_TO_ATTACK");
--		end

		AI.Signal(SIGNALFILTER_SENDER,0,"CONTROL_TROOPER",entity.id);
	end,
