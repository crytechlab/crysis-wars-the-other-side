...
AIBehaviour.DroneAttack = {
	...
	Constructor = function ( self, entity, data )
		...
		AIBehaviour.DroneIdle:Constructor( entity );
		
		entity.AI.lastStrafingPitch = -1.0;
...
--		System.Log("AIPARAM_STRAFINGPITCH "..entity.AI.lastStrafingPitch );
		...
		AI.CreateGoalPipe("DroneFire");
		AI.PushGoal("DroneFire","+locate",0,"atttarget");
		AI.PushGoal("DroneFire","+lookat",0,0,0,true,1);
		AI.PushGoal("DroneFire","+timeout",1,0.5);
		AI.PushGoal("DroneFire","firecmd",0,FIREMODE_FORCED);

		AI.CreateGoalPipe("DroneFire2");
		AI.PushGoal("DroneFire2","+locate",0,"atttarget");
		AI.PushGoal("DroneFire2","+lookat",0,0,0,true,1);
		AI.PushGoal("DroneFire2","firecmd",0,0);
		AI.PushGoal("DroneFire2","+timeout",1,0.1);
		AI.PushGoal("DroneFire2","+firecmd",0,FIREMODE_FORCED);
		AI.PushGoal("DroneFire2","+timeout",1,60.0);

		AI.CreateGoalPipe("DroneFire3");
		AI.PushGoal("DroneFire3","+firecmd",0,0);
		AI.PushGoal("DroneFire3","+locate",0,"atttarget");
		AI.PushGoal("DroneFire3","+lookat",0,0,0,true,1);
		AI.PushGoal("DroneFire3","+timeout",1,1.0);
		AI.PushGoal("DroneFire3","firecmd",0,FIREMODE_FORCED);
		AI.PushGoal("DroneFire3","+timeout",1,60.0);

		AI.CreateGoalPipe("DroneFire4");
		AI.PushGoal("DroneFire4","firecmd",0,FIREMODE_FORCED);
		AI.PushGoal("DroneFire4","+locate",0,"atttarget");
		AI.PushGoal("DroneFire4","+lookat",0,0,0,true,1);
		AI.PushGoal("DroneFire4","+timeout",1,30.0);

		AI.CreateGoalPipe("DroneLookAt");
		AI.PushGoal("DroneLookAt","locate",0,"atttarget");
		AI.PushGoal("DroneLookAt","+lookat",0,0,0,true,1);
		AI.PushGoal("DroneLookAt","timeout",1,60.0);

		AI.CreateGoalPipe("DronePatrol");
		AI.PushGoal("DronePatrol","firecmd",0,0);
		AI.PushGoal("DronePatrol","+lookat",0,-500,0);
		AI.PushGoal("DronePatrol","timeout",1,60.0);

		AI.CreateGoalPipe("DroneFollowPath");
		AI.PushGoal("DroneFollowPath","lookat",0,-500,0);
		AI.PushGoal("DroneFollowPath","run", 1, 1 );
		AI.PushGoal("DroneFollowPath","firecmd", 1, FIREMODE_FORCED);
		AI.PushGoal("DroneFollowPath","followpath", 1, false, false, true, 0, 10.0, false );
		AI.PushGoal("DroneFollowPath","signal",1,1,"SCOUTMOACATTACK_TRACEPATH_END",SIGNALFILTER_SENDER);
		AI.PushGoal("DroneFollowPath","timeout",1,60.0);

		AI.CreateGoalPipe("DroneFollowPathRvs");
		AI.PushGoal("DroneFollowPathRvs","lookat",0,-500,0);
		AI.PushGoal("DroneFollowPathRvs","run", 1, 1 );
		AI.PushGoal("DroneFollowPathRvs","firecmd", 1, FIREMODE_FORCED);
		AI.PushGoal("DroneFollowPathRvs","followpath", 1, false, true, true, 0, 10.0, false );
		AI.PushGoal("DroneFollowPathRvs","signal",1,1,"SCOUTMOACATTACK_TRACEPATH_END",SIGNALFILTER_SENDER);
		AI.PushGoal("DroneFollowPathRvs","timeout",1,60.0);
		...
		Script.SetTimerForFunction( minUpdateTime *1000 , "AIBehaviour.DroneAttack.SCOUTMOACATTACK_UPDATE", entity );
	...
	OnBulletRain = function ( self, entity, sender, data )
		...
		if ( data and data.id ) then
			...
			if ( targetEntity and AIBehaviour.DroneDefault:scoutCheckHostile( entity, targetEntity )==true ) then
			else
				return;
			end
		else
	...
	SCOUTMOACATTACK_DODGE_START = function( self, entity, targetEntity, bHeavyDamage )
		...
		if ( bHeavyDamage == 0 ) then
			...
			--local res = AIBehaviour.SCOUTDEFAULT:ScoutCheckClearanceMain( entity, vTmp, 1.0, 1.0 );
			--if ( res == 0 )then
		...
		FastScaleVector( entity.AI.vDirectionRsvInterrupt, entity.AI.vDirectionRsvInterrupt, 3.0 );
	...
	SCOUTMOACATTACK_UPDATE = function( entity )
		...
		if ( target and AIBehaviour.DroneDefault:scoutCheckHostile( entity, target )==true ) then
		else
			AIBehaviour.DroneAttack:OnNoTarget( entity );
			return;
		end
		...
		if ( AI.GetTargetType( entity.id ) == AITARGET_MEMORY ) then
			...
			if ( target.actor and target.actor:GetNanoSuitMode() == 2 ) then
				if ( entity.AI.CurrentHook ~= fSCOUTMOACATTACK_VSCLOAK ) then
					AIBehaviour.DroneAttack:SCOUTMOACATTACK_VSCLOAK_START( entity );
				end
			end
		end
		...
		if ( entity.AI.bJammer == true ) then
			...
			if ( jam < 30.0 ) then
				...
				NormalizeVector( vJammer );
				FastScaleVector( vJammer, vJammer, 3.0 );
				...
				elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_JAMMERDUSH ) then
					...
					AIBehaviour.DroneAttack:SCOUTMOACATTACK_JAMMER_START( entity );
				end
				return;
			else
...
--		System.Log("AIPARAM_STRAFINGPITCH "..entity.AI.lastStrafingPitch );
		...
		if ( entity.AI.InterruptHook > 0 ) then
			if ( entity.AI.InterruptHook == fSCOUTMOACATTACK_DODGE ) then
				AIBehaviour.DroneAttack:SCOUTMOACATTACK_DODGE( entity );
			end
			return;
		end
		...
		if (     entity.AI.CurrentHook == fSCOUTMOACATTACK_DONOTHING ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_DONOTHING" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DONOTHING( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_BASICAPPROACH ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_BASICAPPROACH" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_BASICAPPROACH( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_HOVERINGUP ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_HOVERINGUP" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_HOVERINGUP( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_JUSTSTAY ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_JUSTSTAY" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_JUSTSTAY( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_GOAWAY ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_GOAWAY" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_GOAWAY( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_POPUP ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_POPUP" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_POPUP( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_SHOOTSINGULARITY ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_SHOOTSINGULARITY" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_SHOOTSINGULARITY( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_CIRCLESTRAFE ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_CIRCLESTRAFE" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_CIRCLESTRAFE( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_STOP ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_STOP" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_STOP( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_SEEKHIDEPOSITION ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_SEEKHIDEPOSITION" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_SEEKHIDEPOSITION( entity );
		elseif (  entity.AI.CurrentHook == fSCOUTMOACATTACK_HIDE ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_HIDE" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_HIDE( entity );
		elseif (  entity.AI.CurrentHook == fSCOUTMOACATTACK_UNHIDE ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_UNHIDE" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_UNHIDE( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_DIRECTSTRAFE ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_DIRECTSTRAFE" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DIRECTSTRAFE( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_DIRECTSTRAFE2 ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_DIRECTSTRAFE2" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DIRECTSTRAFE2( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_LOOPINLOOP ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_LOOPINLOOP" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_LOOPINLOOP( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_LINEATTACK ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_LINEATTACK" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_LINEATTACK( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_BACKATTACK ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_BACKATTACK" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_BACKATTACK( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_LINEATTACK2 ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_LINEATTACK2" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_LINEATTACK2( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_LINEATTACK3 ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_LINEATTACK3" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_LINEATTACK3( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_TRACEPATHPRE ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_TRACEPATHPRE" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_TRACEPATHPRE( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_TRACEPATH ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_TRACEPATH" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_TRACEPATH( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_CIRCLING ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_CIRCLING" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_CIRCLING( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_SHORTDUSH ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_SHORTDUSH" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_SHORTDUSH( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_JAMMER ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_JAMMER" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_JAMMER( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_JAMMERDUSH ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_JAMMERDUSH" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_JAMMERDUSH( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_FOUNDPLAYER ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_FOUNDPLAYER" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_FOUNDPLAYER( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_VSAIR ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_VSAIR" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_VSAIR( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_VSAIR2 ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_VSAIR2" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_VSAIR2( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_VSAIR3 ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_VSAIR3" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_VSAIR3( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_VSAIRPAUSE ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_VSAIRPAUSE" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_VSAIRPAUSE( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_VSAIRCIRCLE ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_VSAIRCIRCLE" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_VSAIRCIRCLE( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_VSAIRUP ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_VSAIRUP" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_VSAIRUP( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACATTACK_VSCLOAK ) then
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_DEBUGLABEL( entity:GetPos(), "SCOUTMOACATTACK_VSCLOAK" );
			AIBehaviour.DroneAttack:SCOUTMOACATTACK_VSCLOAK( entity );
		end
...
--		System.Log(label);
	...
	SCOUTMOACATTACK_FOUNDPLAYER_START = function ( self, entity )
		...
		if ( target and AIBehaviour.DroneDefault:scoutCheckHostile( entity, target )==true ) then
			...
			if (AI.GetTypeOf( target.id ) == AIOBJECT_VEHICLE and AI.GetSubTypeOf( target.id ) == AIOBJECT_HELICOPTER ) then
				AIBehaviour.DroneDefault:SCOUT_CHANGESOUND( entity );
			...
			entity:SelectPipe(0,"DroneLookAt");
	...
	SCOUTMOACATTACK_HOVERINGUP_START = function ( self, entity )
		System.LogAlways("Drone:SCOUTMOACATTACK_HOVERINGUP_START")
		--TheOtherSide
		if (entity.AI.ignoreSignals == true) then
			return;
		end
		...
		if ( target and AIBehaviour.DroneDefault:scoutCheckHostile( entity, target )==true ) then
			...
			entity:SelectPipe(0,"do_nothing");
			entity:SelectPipe(0,"DronePatrol");
	...
	SCOUTMOACATTACK_HOVERINGUP = function ( self, entity )
		...
		vTmp.z =0;
		if ( LengthVector( vTmp ) > 10.0 ) then
			self:SCOUTMOACATTACK_DIRECTSTRAFE2_START( entity );
			return;
		end
	
		CopyVector( vTmp, entity.AI.vDirectionRsv );
		vTmp.z = vTmp.z + ( math.cos( entity.AI.cosinOp ) * 1.0 );
	...
	SCOUTMOACATTACK_CIRCLESTRAFE_START = function( self, entity, sec )
		...
		if ( target and AIBehaviour.DroneDefault:scoutCheckHostile( entity, target )==true ) then
			...
			CopyVector( entity.AI.vMyPosRsv, entity:GetPos() );
			CopyVector( entity.AI.vTargetRsv, target:GetPos() );
			entity:InsertSubpipe( 0, "DroneFire2" );
	...
	SCOUTMOACATTACK_CIRCLESTRAFE = function( self, entity )
		...
		if ( target and AIBehaviour.DroneDefault:scoutCheckHostile( entity, target )==true ) then
			...
			if ( vMyPos.z < vTargetPos.z + 2.0 ) then
				vVelRot.z  = 2.0;
			end
	...
	SCOUTMOACATTACK_GOAWAY_START = function ( self, entity )
		...
		if ( target and AIBehaviour.DroneDefault:scoutCheckHostile( entity, target )==true ) then
			...
			entity.AI.vDirectionRsv.z = 3.0 - ( entity.AI.vMyPosRsv.z - entity.AI.vTargetRsv.z );
			NormalizeVector( entity.AI.vDirectionRsv );
	...
	SCOUTMOACATTACK_GOAWAY = function ( self, entity )
		...
		if ( entity.AI.bLock == false ) then
			...
			if ( entity:GetSpeed() < 10.0 ) then
				...
				local res  = AIBehaviour.SCOUTDEFAULT:ScoutCheckClearanceMain( entity, vDist, 1, 1.5 );
				local vTmp = {};
				local vTmp2 = {};
		...
		if ( target and AIBehaviour.DroneDefault:scoutCheckHostile( entity, target )==true ) then
			...
			SubVectors( vDist, target:GetPos(), entity:GetPos() );
			vDist.z =0;
			if ( LengthVector( vDist ) > 10.0 ) then
				self:SCOUTMOACATTACK_DIRECTSTRAFE2_START( entity );
				return;
			end
			...
			vDist.z = vDist.z + ( math.cos( entity.AI.cosinOp ) * 2.0 );
	...
	SCOUTMOACATTACK_SHOOTSINGULARITY_START = function ( self, entity )
		...
		AI.CreateGoalPipe("DroneMain5");
		AI.PushGoal("DroneMain5","firecmd",0,0);
		AI.PushGoal("DroneMain5","locate",0,"refpoint");
		AI.PushGoal("DroneMain5","lookat",0,0,0,true,1);
		AI.PushGoal("DroneMain5","animation",0,AIANIM_SIGNAL,"fireSingularityCannon");	
		AI.PushGoal("DroneMain5","+timeout",1,3);
		AI.PushGoal("DroneMain5","firecmd",0,FIREMODE_FORCED);
		AI.PushGoal("DroneMain5","+timeout",1,3);
		AI.PushGoal("DroneMain5","+firecmd",1,0);
		AI.PushGoal("DroneMain5","+timeout",1,2);
		AI.PushGoal("DroneMain5","signal",1,1,"SCOUTMOACATTACK_SHOOTSINGULARITY_END",SIGNALFILTER_SENDER);
		AI.PushGoal("DroneMain5","signal",1,1,"SCOUTMOACATTACK_DIRECTSTRAFE2_START",SIGNALFILTER_SENDER);
		entity:SelectPipe(0,"DroneMain5");
		entity.AI.ndtime = 1;
...
--		FastSumVectors( entity.AI.vDirectionRsv, entity.AI.vDirectionRsv, entity:GetDirectionVector(1) );
		...
		NormalizeVector( entity.AI.vDirectionRsv );
		FastScaleVector( entity.AI.vDirectionRsv, entity.AI.vDirectionRsv, 2.0 );
...
--				self:SCOUTMOACATTACK_LOOPINLOOP_START( entity );
	...
	SCOUTMOACATTACK_DIRECTSTRAFE = function ( self, entity )
		...
		if ( dot > 0 ) then
			...
			local height = 4.0 *  math.cos( 3.1416 * distance / 100.0 )   - vMyPos.z;
			...
			local height = 6.0 * math.sin( 3.1416 * distance / 100.0 )  +  entity.AI.vTargetRsv.z + 1.0;
...
--			FastScaleVector( vTmp, vTmp, 5.0 * dot + 15.0 );
			...
			vTmp.z = vTmp.z + ( math.cos( entity.AI.cosinOp ) * 2.0 );

			if ( vMyPos.z < entity.AI.vTargetRsv.z + 3.0 ) then
				local height = entity.AI.vTargetRsv.z + 3.0 - vMyPos.z;
				if ( height > 5.0 ) then
					height = 5.0;
				end
			...
			if ( vMyPos.z > entity.AI.vTargetRsv.z + 4.0 ) then
				local height = entity.AI.vTargetRsv.z + 4.0 - vMyPos.z;
				if ( height < -5.0 ) then
					height = -5.0;
				end
				vTmp.z = vTmp.z + height;
	...
	SCOUTMOACATTACK_LINEATTACK2 = function ( self, entity )
		...
		if ( entity.AI.bLock == false ) then
			...
			if ( entity:GetSpeed() < 8.0 ) then
				...
				local res = AIBehaviour.SCOUTDEFAULT:ScoutCheckClearanceMain( entity, vTmp, 1.0, 1.0 );
				if ( res == 0 ) then
					local res2 = AIBehaviour.SCOUTDEFAULT:ScoutCheckFlock( entity, vTmp, 1.0, 1.0 );
					if ( res2 == false ) then
						local vTmp2 = {};
						CopyVector( vTmp, entity:GetDirectionVector(0) );				
						CopyVector( vTmp2, entity.AI.vDirectionRsv );				
	...
	SCOUTMOACATTACK_BACKATTACK_START = function ( self, entity )
		...
		if ( target and AIBehaviour.DroneDefault:scoutCheckHostile( entity, target )==true ) then
			...
			entity:SelectPipe(0,"do_nothing");
			entity:SelectPipe(0,"DroneFire2");
	...
	SCOUTMOACATTACK_BACKATTACK = function ( self, entity )
		...
		local height = 3.0 * math.sin( ( ( distance ) / 50.0 )  * 3.1416 / 2.0 ) + entity.AI.vTargetRsv.z + 10.0;
		height = height - vMyPos.z ;
	...
	SCOUTMOACATTACK_ISTRACEPOSSIBLE = function ( self, entity )
		...
		if ( length1 < 10.0 and length2 < 5.0 and length3 > 2.0 and vMyPassPos.z > vTargetPos.z + 1.7 and vTargetPassPos.z > vTargetPos.z ) then
	...
	SCOUTMOACATTACK_TRACEPATH_START = function( self, entity )
		...
		if ( entity.AI.traceRvs == false ) then
			entity:SelectPipe(0,"DroneFollowPath");
		else
			entity:SelectPipe(0,"DroneFollowPathRvs");
		end
	...
	SCOUTMOACATTACK_CIRCLING_START = function ( self, entity )
		System.LogAlways("Drone:SCOUTMOACATTACK_CIRCLING_START");
		--TheOtherSide
		if (entity.AI.ignoreSignals == true) then
			return;
		end
		...
		if ( target and AIBehaviour.DroneDefault:scoutCheckHostile( entity, target )==true ) then
			...
			entity:SelectPipe(0,"do_nothing");
			entity:SelectPipe(0,"DroneFire3");
	...
	SCOUTMOACATTACK_CIRCLING = function ( self, entity )
		...
		if ( target and AIBehaviour.DroneDefault:scoutCheckHostile( entity, target )==true ) then
			...
			CopyVector( entity.AI.vTargetRsv, target:GetPos() );
			if ( vMyPos.z > entity.AI.vTargetRsv.z + 14.0 ) then
				vVelRot.z = vVelRot.z - 2.0;
			end

			if ( vMyPos.z < vTargetPos.z + 7.0 ) then
				vVelRot.z  = 2.0;
			end
	...
	SCOUTMOACATTACK_SHORTDUSH_START = function( self, entity )
		...
		if ( target and AIBehaviour.DroneDefault:scoutCheckHostile( entity, target )==true ) then
			...
			local res = AIBehaviour.SCOUTDEFAULT:ScoutCheckClearanceMain( entity, vTmp, 1.0, 2.0 );
			if ( res == 0 ) then
				--entity:PlaySoundEvent("Sounds/alien:scout:retreat", entity.AI.vZero, entity:GetDirectionVector(1), SOUND_DEFAULT_3D, SOUND_SEMANTIC_AI_READABILITY);
				AI.Animation(entity.id,AIANIM_SIGNAL,"readyToFly");
			end			
	...
	SCOUTMOACATTACK_SHORTDUSH = function( self, entity )
		System.LogAlways("Drone:SCOUTMOACATTACK_SHORTDUSH");
		--TheOtherSide
		if (entity.AI.ignoreSignals == true) then
			return;
		end
		...
		if ( target and AIBehaviour.DroneDefault:scoutCheckHostile( entity, target )==true ) then
			...
			local vFwd = {};
			FastScaleVector( vFwd, entity.AI.vDirectionRsv, 2.0 );
			vFwd.z = 1.0;
			local res = AIBehaviour.SCOUTDEFAULT:ScoutCheckClearanceMain( entity, vFwd, 1.0, 1.0 );
	...
	SCOUTMOACATTACK_JAMMER = function ( self, entity )
		...
		if ( target and AIBehaviour.DroneDefault:scoutCheckHostile( entity, target )==true ) then
			...
			if ( jam < 45.0 ) then
				...
				CopyVector( entity.AI.vTargetRsv, target:GetPos() );
				if ( vMyPos.z > entity.AI.vTargetRsv.z + 7.0 ) then
					vVelRot.z = vVelRot.z - 2.0;
				end
	...
	SCOUTMOACATTACK_VSAIR_START = function( self, entity )
		System.LogAlways("Drone:SCOUTMOACATTACK_VSAIR_START");
	...
	SCOUTMOACATTACK_VSAIRPAUSE_START = function( self, entity )
		...
		if ( target and AIBehaviour.DroneDefault:scoutCheckHostile( entity, target )==true ) then
			...
			if ( random( 1,256 ) > 200 and  LengthVector( vTmp ) > 180.0  and target:GetSpeed() <5.0 ) then
				...
				AI.CreateGoalPipe("DroneMain6");
				AI.PushGoal("DroneMain6","+animation",0,AIANIM_SIGNAL,"fireSingularityCannon");	
				AI.PushGoal("DroneMain6","+timeout",1,2);
				AI.PushGoal("DroneMain6","+firecmd",0,FIREMODE_FORCED);
				AI.PushGoal("DroneMain6","+timeout",1,3);
				AI.PushGoal("DroneMain6","+firecmd",1,0);
				AI.PushGoal("DroneMain6","+timeout",1,30.0);
				entity:SelectPipe(0,"DroneMain6");
				entity.AI.bLock = false;
				...
				entity:SelectPipe(0,"do_nothing");
				entity:SelectPipe(0,"DroneFire4" );
				entity.AI.bLock = true;
				entity.AI.CurrentHook = fSCOUTMOACATTACK_VSAIRPAUSE;

				local vTmp = {};
				FastScaleVector( vTmp, entity.AI.vUp , 2.0 );
	...
	SCOUTMOACATTACK_VSAIR3 = function( self, entity )
		...
		if ( target and AIBehaviour.DroneDefault:scoutCheckHostile( entity, target )==true ) then
			...
			CopyVector( vMyPos , entity:GetPos() );
			CopyVector( vTargetPos ,target:GetPos() );
			if ( vTargetPos.z > vMyPos.z + 2.0 ) then
				vTmp3.z = 2.0;
			end
			if ( vTargetPos.z < vMyPos.z - 2.0 ) then
				vTmp3.z = -2.0;
