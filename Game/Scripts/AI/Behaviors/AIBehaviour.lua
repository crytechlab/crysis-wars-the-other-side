...
AIBehaviour = {
	...
	AVAILABLE = 
	{
		...
		TOS_Obey_Follow_and_Protect = "Scripts/AI/TOS/Behaviors/Obey/TOS_Obey_Follow_and_Protect.lua",
		--~TheOtherSide
...
--		Job_WalkCircle	= "Scripts/AI/Behaviors/Personalities/SHARED/Jobs/Job_WalkCircle.lua",
		...
		Job_CombatIdle		= "Scripts/AI/Behaviors/Personalities/SHARED/Jobs/Job_CombatIdle.lua",	
...
--		HostageTied       = "Scripts/AI/Behaviors/Personalities/Hostage/HostageTied.lua",
		...
		-- TrainSoldier
		----------------------------------------------------------
		TrainSoldierIdle	= "Scripts/AI/Behaviors/Personalities/TrainSoldier/TrainSoldierIdle.lua",
		TrainSoldierAttack	= "Scripts/AI/Behaviors/Personalities/TrainSoldier/TrainSoldierAttack.lua",
		----------------------------------------------------------
		...
		-- Trooper
		TrooperCloakIdle = "Scripts/AI/Behaviors/Aliens/Trooper/Cloak/TrooperCloakIdle.lua",
		TrooperIdle = "Scripts/AI/Behaviors/Aliens/Trooper/TrooperIdle.lua",
		TrooperMKIIIdle				= "Scripts/AI/Behaviors/Aliens/TrooperMKII/TrooperMKIIIdle.lua",
		TrooperMKII_SneakIdle				= "Scripts/AI/Behaviors/Aliens/TrooperMKII/TrooperMKII_SneakIdle.lua",
		
		TrooperLure = "Scripts/AI/Behaviors/Aliens/Trooper/TrooperLure.lua",
		TrooperGuardianIdle = "Scripts/AI/Behaviors/Aliens/Trooper/Guardian/TrooperGuardianIdle.lua",
		TrooperLeaderMKIIIdle = "Scripts/AI/Behaviors/Aliens/Trooper/Leader/TrooperLeaderMKIIIdle.lua",
		...
		DroneIdle = "Scripts/AI/Behaviors/Aliens/Drone/DroneIdle.lua",
		...
		-- Hunter
		HunterNewIdle = "Scripts/AI/Behaviors/Aliens/HunterNew/HunterNewIdle.lua",
		HunterNewPatrol = "Scripts/AI/Behaviors/Aliens/HunterNew/HunterNewPatrol.lua",
		HunterNewAttack = "Scripts/AI/Behaviors/Aliens/HunterNew/HunterNewAttack.lua",
		-- Warrior
...
--		HostageFollowed   = "Scripts/AI/Behaviors/Personalities/Hostage/HostageFollowed.lua",
		...
		VtolFlyTOS				= "Scripts/AI/Behaviors/Vehicles/Vtol/VtolFlyTOS.lua",	
...
--		ClimbLadder		= "Scripts/AI/Behaviors/Personalities/SHARED/Other/ClimbLadder.lua",
		...
		--Trooper tranquilization
		TrooperDown = "Scripts/AI/Behaviors/Aliens/Trooper/Salvager/TrooperDown.lua",
				
		-- Trooper MK II.
		Trooper2Attack				= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2Attack.lua",
		Trooper2AttackGroup			= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2AttackGroup.lua",
		Trooper2Hide				= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2Hide.lua",
		Trooper2Threatened			= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2Threatened.lua",
		Trooper2ThreatenedStandby	= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2ThreatenedStandby.lua",
		Trooper2Interested			= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2Interested.lua",
		Trooper2Seek				= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2Seek.lua",
		Trooper2Search				= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2Search.lua",
		--Trooper2Reload				= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2Reload.lua",
	
		Trooper2AvoidExplosives		= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2AvoidExplosives.lua",
		Trooper2AvoidVehicle		= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2AvoidVehicle.lua",
		Trooper2CheckDead			= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2CheckDead.lua",
		Trooper2CallReinforcements	= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2CallReinforcements.lua",
		
		Trooper2Dumb 				= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2Dumb.lua",
		
		Trooper2AttackT						= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2AttackT.lua",
		
		Trooper2AttackSwitchPosition		= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2AttackSwitchPosition.lua",
		Trooper2AttackSwitchPositionMelee	= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2AttackSwitchPositionMelee.lua",
		
		Trooper2GrabbedByScout				= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2GrabbedByScout.lua",
		
		--Trooper2ShootOnSpot					= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2ShootOnSpot.lua",
		Trooper2ShootOnRock					= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2ShootOnRock.lua",
		Trooper2ShootOnWall					= "Scripts/AI/Behaviors/Aliens/TrooperMKII/Trooper2ShootOnWall.lua",
		...
		ScoutMOACKamikaze = "Scripts/AI/Behaviors/Aliens/ScoutMOAC/ScoutMOACKamikaze.lua",
		-- ScoutMOAR
		...
		DroneAttack = "Scripts/AI/Behaviors/Aliens/Drone/DroneAttack.lua",
		DronePatrol = "Scripts/AI/Behaviors/Aliens/Drone/DronePatrol.lua",
		DroneDefault = "Scripts/AI/Behaviors/Aliens/Drone/DroneDefault.lua",
