...
AICharacter.SuitHurricane = {
	...
	AnyBehavior = {
		...
		GO_TO_ATTACK            = "SuitHurricaneAttack",
		GO_TO_THREATENED        = "SuitHurricaneThreatened",
	},
	--TheOtherSide
	TOS_Obey = {
		-- Стандартные сигналы
		...
		OnFallAndPlayWakeUp              = "SuitHurricaneIdle",
		OnBackOffFailed                  = "",
		...
		GO_TO_ATTACK_FORCED              = "SuitHurricaneAttack",
		...
		GO_TO_THREATENED_FORCED          = "SuitHurricaneThreatened",
		...
		GO_TO_IDLE_FORCED                = "SuitHurricaneIdle",
