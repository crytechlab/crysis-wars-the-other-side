...
--	$DateTime$
--   Description: 
--#  Flanking the enemy using cover
--# He runs only in combat mode
--# If enemy isn't visible anymore he sneaks from cover while looking at the last known position of the enemy (strafing)
--# He doesn't do covering fire
--# During combat he prefers to move sidewards than straight towards the enemy
--# When going from cover to cover he prefers to keep soft cover between the enemy or his last know position
--  
--------------------------------------------------------------------------
--  History:
...
--		AI.Signal(SIGNALFILTER_SENDER,1,"ConstructorSneaker",entity.id);
	...
	AnyBehavior = {
		...
		GO_TO_ATTACK				= "SneakerAttack",
		GO_TO_ATTACK_GROUP	= "SneakerAttackGroup",
	...
	TOS_Obey = {
		...
		GO_TO_ATTACK_FORCED				= "SneakerAttack",
		GO_TO_ATTACK_GROUP_FORCED	= "SneakerAttackGroup",
